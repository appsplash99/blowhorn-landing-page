    ...
    <nav className="bg-red-600 relative">
      <div className="h-1/5 md:h-28 flex bg-white flex-wrap items-center justify-between p-4 border-b-2 border-gray-300">
        ...
        <div className="flex gap-2 items-center">
          <Button className="py-2 px-2 bg-white hover:bg-gray-100 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-indigo-600 w-22 md:w-24 transition ease-in duration-200 text-center font-semibold focus:outline-none focus:ring-2 focus:ring-offset-0 rounded-full text-xs md:text-base">
            Sign In
          </Button>
          <Button className="py-2 px-2 bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-22 md:w-24 transition ease-in duration-200 text-center font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-full text-xs md:text-base">
            Sign Up
          </Button>
        </div>
      </div>
